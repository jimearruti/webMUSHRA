...
nls['en']['mosQuestion'] = "Rate the naturalness of the timbre transfer variations overall, where excellent means that the transitions happened as you expected them to, while bad means that the transitions were mostly unexpected";
...
nls['de']['mosQuestion'] = "Rate the naturalness of the timbre transfer variations overall, where very natural means that the transitions happened as you expected them to, while not natural at all means that the transitions were mostly unexpected";
...
nls['fr']['mosQuestion'] = "Rate the naturalness of the timbre transfer variations overall, where very natural means that the transitions happened as you expected them to, while not natural at all means that the transitions were mostly unexpected";
...
nls['es']['mosQuestion'] = "Rate the naturalness of the timbre transfer variations overall, where very natural means that the transitions happened as you expected them to, while not natural at all means that the transitions were mostly unexpected";
