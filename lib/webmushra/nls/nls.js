...
// captions morphing
nls['en']['sourceInstrument'] = "Source Instrument";
nls['en']['targetInstrument'] = "Target Instrument";
nls['en']['mosQuestion'] = "Considering all the clips you listened to, how natural does the morph from the source instrument to the target instrument sound?";
nls['en']['veryNatural'] = "Very natural";
nls['en']['somewhatNatural'] = "Somewhat natural";
nls['en']['neutralNatural'] = "Fair";
nls['en']['somewhatUnnatural'] = "Somewhat unnatural";
nls['en']['notNaturalAtAll'] = "Not natural at all";
nls['en']['commentLabel'] = "Comments (optional):";
...
nls['de']['35'] = "Anchor35";
nls['de']['75'] = "Anchor75";
nls['de']['sourceInstrument'] = "Source Instrument";
nls['de']['targetInstrument'] = "Target Instrument";
nls['de']['mosQuestion'] = "Considering all the clips you listened to, how natural does the morph from the source instrument to the target instrument sound?";
nls['de']['veryNatural'] = "Very natural";
nls['de']['somewhatNatural'] = "Somewhat natural";
nls['de']['neutralNatural'] = "Fair";
nls['de']['somewhatUnnatural'] = "Somewhat unnatural";
nls['de']['notNaturalAtAll'] = "Not natural at all";
nls['de']['commentLabel'] = "Kommentare (optional):";
...
nls['fr']['35'] = "Ancre35";
nls['fr']['75'] = "Ancre75";
nls['fr']['sourceInstrument'] = "Instrument Source";
nls['fr']['targetInstrument'] = "Instrument Cible";
nls['fr']['mosQuestion'] = "Considering all the clips you listened to, how natural does the morph from the source instrument to the target instrument sound?";
nls['fr']['veryNatural'] = "Very natural";
nls['fr']['somewhatNatural'] = "Somewhat natural";
nls['fr']['neutralNatural'] = "Fair";
nls['fr']['somewhatUnnatural'] = "Somewhat unnatural";
nls['fr']['notNaturalAtAll'] = "Not natural at all";
nls['fr']['commentLabel'] = "Commentaires (facultatif) :";
...
nls['es']['35'] = "Ancla35";
nls['es']['75'] = "Ancla75";
nls['es']['sourceInstrument'] = "Instrumento Origen";
nls['es']['targetInstrument'] = "Instrumento Objetivo";
nls['es']['mosQuestion'] = "Considering all the clips you listened to, how natural does the morph from the source instrument to the target instrument sound?";
nls['es']['veryNatural'] = "Very natural";
nls['es']['somewhatNatural'] = "Somewhat natural";
nls['es']['neutralNatural'] = "Fair";
nls['es']['somewhatUnnatural'] = "Somewhat unnatural";
nls['es']['notNaturalAtAll'] = "Not natural at all";
nls['es']['commentLabel'] = "Comentarios (opcional):";
