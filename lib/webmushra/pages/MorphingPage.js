...
MorphingPage.prototype.renderCanvas = function(_parentId) {
  ...
  // centered between the two reference play buttons, closer to the grid
  var xBetweenPlayButtons = ($('#buttonReference0').offset().left + $('#buttonReference100').offset().left + $('#buttonReference100').width()) / 2.0 + xAbsTableOffset;
  var xLetters = (xBetweenPlayButtons + xDrawingStart) / 2.0;
