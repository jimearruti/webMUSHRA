...
MorphingPage.prototype.init = function () {
  ...
  var mosResponseConfig = [
    {value: 5, label: localizer.getFragment(this.language, 'veryNatural')},
    {value: 4, label: localizer.getFragment(this.language, 'somewhatNatural')},
    {value: 3, label: localizer.getFragment(this.language, 'neutralNatural')},
    {value: 2, label: localizer.getFragment(this.language, 'somewhatUnnatural')},
    {value: 1, label: localizer.getFragment(this.language, 'notNaturalAtAll')}
  ];
...
MorphingPage.prototype.renderCanvas = function(_parentId) {
  ...
  // aligned with the score numbers so they read together
  canvasContext.font = "1.25em Calibri";
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'targetInstrument'), xTextScoreRanges, YfirstLine - labelMargin / 2);
  canvasContext.fillText(this.pageManager.getLocalizer().getFragment(this.language, 'sourceInstrument'), xTextScoreRanges, prevScalesHeight + YfirstLine + labelMargin / 2);
